...
var admonitions = function () {
    return function (tree) {
        visit(tree, function (node, idx, parent) {
            var _a;
            if (node.type === 'containerDirective') {
                var type = node.name;
                var ad = customTypes[type];
                if (ad) {
                    var _b = node.children, mayBeLabel = _b[0], restChildren = _b.slice(1);
                    var icon = (node.attributes || {}).icon;
                    var _c = (icon || '').split(':'), collection = _c[0], name = _c[1];
                    var title = type.toUpperCase();
                    var hasLabel = false;
                    if (mayBeLabel && ((_a = mayBeLabel.data) === null || _a === void 0 ? void 0 : _a.directiveLabel)) {
                    ...
                    parent.children.splice(idx, 1, {
                        ...
                        data: {
                            hName: 'div',
                            hProperties: {
                                className: "admonition admonition-".concat(type),
                            },
                        },
                        children: [
                            {
                                ...
                                children: [
                                    {
                                        ...
                                        children: [{
                                                type: 'html',
                                                value: icon ? "<IconifyIcon collection=\"".concat(collection, "\" name=\"").concat(name, "\" />") : ad.svg,
                                            }],
                                    },
                                    {
                                        type: 'text',
